...
namespace microQiskit {
    ...
    //% group="Circuits" weight=90 blockSetVariable=circuit
    ...
    //% group="Gates" weight=65 inlineInputMode=external
    //% circuitId.shadow=variables_get circuitId.defl=circuit
    ...
    //% group="Gates" weight=60 inlineInputMode=external
    //% circuitId.shadow=variables_get circuitId.defl=circuit
    //% theta.defl=1.57079632679
    //% control.min=0 control.max=7 control.defl=0
    //% target.min=0 target.max=7 target.defl=1
    ...
    //% group="Measurement" weight=100 inlineInputMode=external
    //% circuitId.shadow=variables_get circuitId.defl=circuit
    //% qubit.min=0 qubit.max=7 qubit.defl=0
    ...
    //% group="Simulation" weight=90 blockSetVariable=job inlineInputMode=external
    //% circuitId.shadow=variables_get circuitId.defl=circuit
    //% shots.min=1 shots.max=2048 shots.defl=1024
    ...
    //% group="Advanced" weight=70 blockSetVariable=job inlineInputMode=external
    //% circuitId.shadow=variables_get circuitId.defl=circuit
    //% shots.min=1 shots.max=2048 shots.defl=1024
    ...
    //% group="Advanced" weight=75 inlineInputMode=external
    //% circuitId.shadow=variables_get circuitId.defl=circuit
    ...
    //% group="Advanced" weight=100 inlineInputMode=external
    //% circuitId.shadow=variables_get circuitId.defl=circuit
    ...
    //% group="Advanced" weight=95 inlineInputMode=external
    //% circuitId.shadow=variables_get circuitId.defl=circuit
