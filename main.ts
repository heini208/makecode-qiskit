...
//% groups='["Circuits", "Gates", "Measurement", "Simulation", "Results", "Statevector"]'
namespace microQiskit {
    ...
    //% group="Circuits" weight=100 blockSetVariable=circuit
    ...
    //% group="Circuits" weight=100 blockSetVariable=circuit blockHidden=true
    ...
    //% group="Circuits" weight=95 blockHidden=true
    ...
    //% group="Circuits" weight=90 blockHidden=true
    //% circuitId.shadow=variables_get circuitId.defl=circuit
    ...
    //% group="Circuits" weight=85 blockHidden=true
    //% circuitId.shadow=variables_get circuitId.defl=circuit
    ...
    //% group="Circuits" weight=80 blockHidden=true
    //% circuitId.shadow=variables_get circuitId.defl=circuit
    ...
    //% group="Gates" weight=100 inlineInputMode=external blockHidden=true
    //% circuitId.shadow=variables_get circuitId.defl=circuit
    ...
    //% group="Gates" weight=90 inlineInputMode=external blockHidden=true
    //% circuitId.shadow=variables_get circuitId.defl=circuit
    //% theta.defl=1.57079632679
    //% control.min=0 control.max=7 control.defl=0
    //% target.min=0 target.max=7 target.defl=1
    ...
    //% group="Measurement" weight=100 inlineInputMode=external blockHidden=true
    //% circuitId.shadow=variables_get circuitId.defl=circuit
    //% qubit.min=0 qubit.max=7 qubit.defl=0
    ...
    //% group="Simulation" weight=100 blockSetVariable=job
    //% circuitId.shadow=variables_get circuitId.defl=circuit
    ...
    //% group="Simulation" weight=100 blockSetVariable=job inlineInputMode=external blockHidden=true
    //% circuitId.shadow=variables_get circuitId.defl=circuit
    //% shots.min=1 shots.max=2048 shots.defl=1024
    ...
    //% group="Simulation" weight=90 blockSetVariable=job inlineInputMode=external blockHidden=true
    //% circuitId.shadow=variables_get circuitId.defl=circuit
    //% shots.min=1 shots.max=2048 shots.defl=1024
    ...
    //% group="Results" weight=100 blockHidden=true
    ...
    //% group="Results" weight=95 blockHidden=true
    //% jobId.shadow=variables_get jobId.defl=job
    ...
    //% group="Results" weight=90 blockHidden=true
    //% jobId.shadow=variables_get jobId.defl=job
    ...
    //% group="Results" weight=85 blockHidden=true
    //% jobId.shadow=variables_get jobId.defl=job
    ...
    //% group="Statevector" weight=100 blockHidden=true
    //% circuitId.shadow=variables_get circuitId.defl=circuit
    ...
    //% group="Statevector" weight=90 inlineInputMode=external blockHidden=true
    //% circuitId.shadow=variables_get circuitId.defl=circuit
    ...
    //% group="Statevector" weight=75 blockHidden=true
    //% jobId.shadow=variables_get jobId.defl=job
    ...
    //% group="Statevector" weight=70 blockHidden=true
    //% jobId.shadow=variables_get jobId.defl=job
    ...
    //% group="Initialization" weight=100 inlineInputMode=external blockHidden=true
    //% circuitId.shadow=variables_get circuitId.defl=circuit
    ...
    //% group="Initialization" weight=90 inlineInputMode=external blockHidden=true
    //% circuitId.shadow=variables_get circuitId.defl=circuit
    ...
    //% group="Statevector" weight=65 blockHidden=true
    //% jobId.shadow=variables_get jobId.defl=job
    ...
    //% group="Statevector" weight=60 blockHidden=true
    //% jobId.shadow=variables_get jobId.defl=job
    ...
    //% group="Diagnostics" weight=10 blockHidden=true
